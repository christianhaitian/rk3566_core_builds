...
class OSK:
    ...
    def setup_frame(self, title, input_title, input_value):
        ...
        osk = Pile([
                ...
                WrappableColumns([
                    (1, Text(" ")),
                    (9, Key('â†‘ Shift', shifted='â†‘ SHIFT', callback=self.shift_key_press)),
                    (2, Text(" ")),
                    (15, Key('Space', value=' ', shifted=' ')),
                    (2, Text(" ")),
                    (10, Key('Delete â†', callback=self.bksp_key_press)),
                    ], 0),
                Divider()
              ])
        ...
        if self.small_display:
            ...
            body = Pile([
                        ...
                        LineBox(
                            GridFlow([ok_btn, cancel_btn], 10, 2, 0, 'center'),
                            bline=None, lline=None, rline=None, tlcorner='â”€', trcorner='â”€')
                        ])
            """
            body = Pile([
                        Divider(), input,
