...
##################################################################
	 ...
	 if [[ ! -z "$mupen64plus_core_patches" ]]; then
      ...
      ./src/getRevision.sh
      cmake -DNOHQ=On -DCRC_ARMV8=On -DEGL=On -DNEON_OPT=On -DMUPENPLUSAPI=On -DCMAKE_CXX_FLAGS:STRING=" -march=armv8-a+crc -mtune=cortex-a55 -fuse-linker-plugin" -S src -B projects/cmake
