...
bitness="$(getconf LONG_BIT)"
	...
	cd ..
	 ...
	 if [[ ! -z "$ppsspp_patches" ]]; then
	  ...
	  echo " "
	  echo "PPSSPPSDL 2019 executable and ppssppsdl_2019_pkg_$(git rev-parse HEAD | cut -c -7).tar.gz package has been created and has been placed in the rk3566_core_builds/ppsspp-2021_$bitness subfolder"
