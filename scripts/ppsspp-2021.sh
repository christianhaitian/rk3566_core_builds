...
bitness="$(getconf LONG_BIT)"
	...
	cd ..
	 ...
	 if [[ ! -z "$ppsspp_patches" ]]; then
	  ...
	  cp PPSSPPSDL ../../ppsspp-2021_$bitness/.
	  tar -zchvf ../../ppsspp-2021_$bitness/ppssppsdl_2019_pkg_$(git rev-parse HEAD | cut -c -7).tar.gz assets/ PPSSPPSDL

	  echo " "
	  echo "PPSSPPSDL 2021 executable and ppssppsdl_2021_pkg_$(git rev-parse HEAD | cut -c -7).tar.gz package has been created and has been placed in the rk3566_core_builds/ppsspp-2021_$bitness subfolder"
