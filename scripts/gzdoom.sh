	...
	if [[ "$var" == "gzdoom" ]] && [[ "$bitness" == "64" ]]; then
	 ...
	 if [[ ! -z "$gzdoomsa_patches" ]]; then
	  ...
	  do
		 if [[ $patching == *"chi"* ]]; then
          ...
          if [[ $rg351v_patch == "yes" ]]; then
                ...
                echo " "
                echo "The gzdoom.351v executable file haa been created and been placed in the rk3566_core_builds/gzdoom$bitness subfolder"
          fi
	  ...
	  if [[ ${chi_patch} == "yes" ]]; then
		...
		echo " "
		echo "The gzdoom.chi executable file haa been created and been placed in the rk3566_core_builds/gzdoom$bitness subfolder"
	  fi
